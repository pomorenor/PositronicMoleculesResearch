...
#SBATCH --job-name=LiClCl3
#SBATCH --clusters=cecc
#SBATCH --partition=cpu.cecc
#SBATCH --nodes=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=64G
#SBATCH --output=/homes/qteorica/rafael/BO2-e+F-/NAME.lowdin_%j.out
#SBATCH --error=/homes/qteorica/rafael/BO2-e+F-/NAME.lowdin_%j.err
...
#SBATCH --export=SCRATCH_DIR=/scratch/$SLURM_JOB_ACCOUNT/$SLURM_JOB_USER/$SLURM_JOB_ID
	...
	cd $SCRATCH_DIR
	singularity run /localapps/lowdinXQMeCha.sif  ./script3.sh
