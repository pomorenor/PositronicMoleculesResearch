...
for STEP in "${!DIST[@]}"; do
	...
	ENERGY_USUAL=$(awk '{lines[NR]=$0} /END OF GENERALIZED ANY-PARTICLE PROPAGATOR CALCULATIONS/ {print lines[NR-2]}' $LOWDIN_OUTPUT_USUAL | awk '/REN-P3/ {print $2*0.03674931}')
