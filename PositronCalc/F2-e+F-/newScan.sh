...
TEMPLATE_USUAL_CALC="/home/pohl/Desktop/PositronMoleculeSystems/PositronicMoleculesResearch/PositronCalc/F2-e+F-/template_with_guess.lowdin"
...
for STEP in "${!DIST[@]}"; do
	...
	LOWDIN_FILE_USUAL="c_guess_$STEP.lowdin"
	LOWDIN_OUTPUT_USUAL="c_guess_$STEP.out"
	...
	lowdin2 -i $LOWDIN_FILE_USUAL -n 9
