...
TEMPLATE_USUAL_CALC="/home/pohl/Desktop/PositronMoleculeSystems/PositronicMoleculesResearch/PositronCalc/F2-e+F-/template_usual.lowdin"
...
for STEP in "${!DIST[@]}"; do
	...
	LOWDIN_FILE_USUAL="c_$STEP.lowdin"
	LOWDIN_OUTPUT_USUAL="c_$STEP.out"
